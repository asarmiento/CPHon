...
<p style="font-size: 14px;margin: 0;">Sueldo Promedio Cont.: {{ number_format( ($dataAffiliate[count($dataAffiliate)-1][1]/$dataAffiliate[count($dataAffiliate)-1][2]), 2, '.', ',') }} </p>
...
<p style="font-size: 14px;margin: 0;">Sueldo Promedio 10%.: {{  number_format( ($dataPrivate[count($dataPrivate)-1][1]/$dataPrivate[count($dataPrivate)-1][2]), 2, '.', ',') }}</p>
